...
$ZabbixInstallPath = "C:\zabbix\conf"
$ZabbixSenderInstallPath = "C:\zabbix\bin"
...
$Sender = "$ZabbixSenderInstallPath\zabbix_sender.exe"
$Senderarg1 = '-vv'
$Senderarg2 = '-c'
$Senderarg3 = "$ZabbixInstallPath\zabbix_agentd.win.conf"
$Senderarg4 = '-i'
